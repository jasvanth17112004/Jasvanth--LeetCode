<h2><a href="https://leetcode.com/problems/concatenate-non-zero-digits-and-multiply-by-sum-ii/solutions/?envType=daily-question&envId=2026-07-08">3756. Concatenate Non-Zero Digits and Multiply by Sum II</a></h2><h3>Medium</h3><hr><p>You are given a string <code>s</code> of length <code>m</code> consisting of digits. You are also given a 2D integer array <code>queries</code>, where <code>queries[i] = [l<sub>i</sub>, r<sub>i</sub>]</code>.</p>
